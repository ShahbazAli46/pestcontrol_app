...
import 'package:accurate/superadmin/Components/EditQuote/EditAddServicesScreen.dart';
import 'package:accurate/superadmin/Components/EditQuote/EditBillingMethodScreen.dart';
...
class EditServicesSelectionScreen extends StatefulWidget {
  const EditServicesSelectionScreen({Key? key}) : super(key: key);

  @override
  State<EditServicesSelectionScreen> createState() => _EditServicesSelectionScreenState();
}

class _EditServicesSelectionScreenState extends State<EditServicesSelectionScreen> {
          ...
          children: [
            ...
            Container(
                ...
                child: GreenButtonBordered(title: "Add Service", sendingData: false.obs, onTap: (){
                  UiHelper.navigateToNextScreen(context, EditAddServicesScreen(addServiceInArray: (value){
            ...
            Padding(
              ...
              child: GreenButton(title: "Next", sendingData: false.obs, onTap: (){
                if (controller.quoteServices.isEmpty){
                  ...
                  UiHelper.navigateToNextScreen(context, EditBillingMethodScreen());
                }
