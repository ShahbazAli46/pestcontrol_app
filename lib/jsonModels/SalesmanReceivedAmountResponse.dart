class SalesmanReceivedAmountResponse {
  String? startDate;
  String? endDate;
  List<SalesmanReceivedAmountResponseData>? data;

  SalesmanReceivedAmountResponse({this.startDate, this.endDate, this.data});

  SalesmanReceivedAmountResponse.fromJson(Map<String, dynamic> json) {
    startDate = json['start_date'];
    endDate = json['end_date'];
    if (json['data'] != null) {
      data = <SalesmanReceivedAmountResponseData>[];
      json['data'].forEach((v) {
        data!.add(new SalesmanReceivedAmountResponseData.fromJson(v));
      });
    }
  }
...
class SalesmanReceivedAmountResponseData {
  int? id;
  ...
  int? isTakenCheque;
  User? user;
  List<AmountHistory>? amountHistory;

  SalesmanReceivedAmountResponseData(
      {this.id,
  ...
  SalesmanReceivedAmountResponseData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    if (json['amount_history'] != null) {
      amountHistory = <AmountHistory>[];
      json['amount_history'].forEach((v) {
        amountHistory!.add(new AmountHistory.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.amountHistory != null) {
      data['amount_history'] =
          this.amountHistory!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class AmountHistory {
  ...
  AmountHistory.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    serviceInvoiceId = json['service_invoice_id'];
    userId = json['user_id'];
    paidAmt = json['paid_amt'];
    remainingAmt = json['remaining_amt'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['user_id'] = this.userId;
    data['paid_amt'] = this.paidAmt;
    data['remaining_amt'] = this.remainingAmt;
