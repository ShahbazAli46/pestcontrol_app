class ViewAllProductsResponse {
  List<ViewAllProductsResponseData>? data;

  ViewAllProductsResponse({this.data});

  ViewAllProductsResponse.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <ViewAllProductsResponseData>[];
      json['data'].forEach((v) {
        data!.add(new ViewAllProductsResponseData.fromJson(v));
      });
    }
  }
...
class ViewAllProductsResponseData {
  int? id;
  String? productName;
  String? batchNumber;
  int? brandId;
  ...
  ViewAllProductsResponseData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
