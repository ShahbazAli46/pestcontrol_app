...
class AllJobsResponse {
  ...
  AllJobsResponse({this.startDate, this.endDate, this.data});
  ...
  AllJobsResponse.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      data = <CaptainJobs>[];
      json['data'].forEach((v) {
        data!.add(new CaptainJobs.fromJson(v));
      });
    }
  }
...
class AllJobsResponseData {
  ...
  AllJobsResponseData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    userId = json['user_id'];
